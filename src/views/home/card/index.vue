...
<template>
    <div class="content">
        <el-card v-for="o in 10" :key="o" shadow="hover" class="box" :body-style="{ width: '100%' }">
            <div class="box-card">
                <div class="hospital">
                    <div class="name">
                        泉州市第一医院
        ...
        <el-pagination v-model:current-page="pageData.currennt" v-model:page-size="pageData.pageSize"
            :page-sizes="[10, 20, 30, 40]" :background="true" layout="prev, pager, next, jumper, ->,sizes, total" :total="50"
            class="pagination" />
    </div>
</template>
